    ...
    def calculateDistances(self, points, tags):
        ...
        for (p, tag) in zip(points, tags):
            ...
            if self.distance_metric == "euclidean":
                distorsion += cuadraticEuclideanDistanceSparseManual(p, self.centroids[tag])
            elif self.distance_metric == "angular":
                distorsion += cosineSimilaritySparseManual(p, self.centroids[tag])
        return distorsion
    ...
    def listen(self): 
        ...
        while True:
            ...
            if msg["action"] == "new_dataset":
                ...
                #Calcular la distancia de los puntos a su centroide
                updated_centroids = False
                ini = msg["position"]
